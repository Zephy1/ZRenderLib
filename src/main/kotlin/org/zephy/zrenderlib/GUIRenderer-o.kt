...
////#endif
//
//object `GUIRenderer-o` : BaseGUIRenderer() {
...
//////        for (i in 0..edges) {
//////            edgeVertices.add(Pair(circleX * xScale + xPosition, circleY * yScale + yPosition))
//////            xHolder = circleX
//////            circleX = cos * circleX - sin * circleY
//////            circleY = sin * xHolder + cos * circleY
//////        }
////
//////        val centerPoint = Pair(xPosition, yPosition)
//////        for (i in 0 until edges) {
//////            vertexList.add(centerPoint)
...
////
//////        for (i in 0 until edges) {
//////            val vx1 = circleX * xScale + xPosition
//////            val vy1 = circleY * yScale + yPosition
//////
//////            xHolder = circleX
//////            circleX = cos * circleX - sin * circleY
//////            circleY = sin * xHolder + cos * circleY
//////
//////            val vx2 = circleX * xScale + xPosition
//////            val vy2 = circleY * yScale + yPosition
//////
//////            vertexList.add(Pair(xPosition, yPosition))
//////            vertexList.add(Pair(vx2, vy2))
//////            vertexList.add(Pair(vx1, vy1))
//////
//////            minX = minOf(minX, vx1, vx2)
//////            maxX = maxOf(maxX, vx1, vx2)
//////            minY = minOf(minY, vy1, vy2)
//////            maxY = maxOf(maxY, vy1, vy2)
//////        }
////        val edgePoints = mutableListOf<Pair<Float, Float>>()
////
////        for (i in 0..edges) {
////            val angle = (i.toFloat() / edges) * 2 * PI.toFloat()
////            val circleX = cos(angle)
////            val circleY = sin(angle)
////
////            val vx = circleX * xScale + xPosition
////            val vy = circleY * yScale + yPosition
////            edgePoints.add(Pair(vx, vy))
////
////            minX = minOf(minX, vx)
////            maxX = maxOf(maxX, vx)
////            minY = minOf(minY, vy)
...
////
////        for (i in 0..edges) {
////            val (vx1, vy1) = edgePoints[i]
////            val (vx2, vy2) = edgePoints[(i + 1) % edges]
////
////            vertexList.add(Pair(xPosition, yPosition))
////            vertexList.add(Pair(vx2, vy2))
////            vertexList.add(Pair(vx1, vy1))
...
//////            val vx = circleX * xScale + xPosition
//////            val vy = circleY * yScale + yPosition
//////            vertexList.add(Pair(vx, vy))
//////            minX = minOf(minX, vx, xPosition)
//////            maxX = maxOf(maxX, vx, xPosition)
//////            minY = minOf(minY, vy, yPosition)
//////            maxY = maxOf(maxY, vy, yPosition)
//////            xHolder = circleX
//////            circleX = cos * circleX - sin * circleY
//////            circleY = sin * xHolder + cos * circleY
//////            vertexList.add(Pair(circleX * xScale + xPosition, circleY * yScale + yPosition))
//////        }
////
////        //#if MC<=12105
////        //$$RenderUtils
...
////        //$$    .translate(-xPosition + -xRotationOffset, -yPosition + -yRotationOffset, 0f)
////        //$$    .begin(RenderLayers.TRIANGLES_ESP())
////        //$$    .colorizeRGBA(color)
////        //$$    .translate(0f, 0f, zOffset)
////        //$$    .cameraPosList(vertexList, 0f)
////        //$$    .draw()
...
//////                )
//////            )
//////            .withVertexFormat(VertexFormats.POSITION_COLOR, DrawMode.TRIANGLE_FAN.toMC())
//////            .build()
////        drawContext.state.addSimpleElement(
////            GUIRenderState(
////                drawContext.matrices,
...
////                zOffset,
////                RenderUtils.RGBAColor.fromLongRGBA(color),
////                RenderPipelines.TRIANGLES_ESP()
////                    .setLocation("circle_${System.nanoTime()}")
////                    .setBufferSize(RenderLayer.DEFAULT_BUFFER_SIZE * 4)
////                    .build(),
////                TextureSetup.empty(),
////                null,
////            )
